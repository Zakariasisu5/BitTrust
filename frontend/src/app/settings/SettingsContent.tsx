...
const MINT_AMOUNT = "100000000"; // 100 USDCx (6 decimals)
      ...
      <Card className="matte-card relative overflow-hidden">
        ...
        <CardHeader className="relative z-10 border-b border-slate-800/50 bg-slate-900/30">
          <CardTitle className="text-sm font-mono flex items-center gap-2 text-slate-400">
            <Coins className="h-4 w-4 text-amber-500" /> [{">"} TESTNET_TOKENS]
          </CardTitle>
          <CardDescription className="text-slate-500 text-xs font-mono">
            Claim test USDCx for local testing. Testnet only.
          </CardDescription>
        </CardHeader>
      ...
      <Card className="matte-card relative overflow-hidden">
        ...
        <CardContent className="space-y-6 pt-6 relative z-10">
          <div className="flex items-center justify-between">
            ...
            <Switch checked={x402Auto} onCheckedChange={setX402Auto} className="data-[state=checked]:bg-emerald-500" />
          </div>
